...
classdef environment < mWidar
    ...
    methods
        ...
        function obj = environment(varargin)
            ...
            %%% Strictly less: a one-sample life gives the generator a zero
            %%% duration to divide by. These are forwarded to generator, so the
            %%% two classes share one definition of each target's lifetime.
